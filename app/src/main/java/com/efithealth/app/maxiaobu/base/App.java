...
public class App extends MultiDexApplication {
    /*old_begin   old_begin   old_begin   old_begin   old_begin   old_begin   old_begin   old_begin   */
    ...
    /*old_end   old_end   old_end   old_end   old_end   old_end   old_end   old_end   old_end   old_end   */
...
//// 百度MAP///////////////////////////////////////////////////////////////////////
/*百度MAP_begin  百度MAP_begin  百度MAP_begin  百度MAP_begin  百度MAP_begin  百度MAP_begin  */
    /**
     * 设置百度MAP 定位相关参数
     */
...
/*上面old  上面old  上面old  上面old  上面old  上面old  上面old  上面old  */
            SPUtils.putFloat(instance, Index.LONGITUDE,(float)location.getLongitude());
            SPUtils.putFloat(instance, Index.LATITUDE,(float)location.getLatitude());
            SPUtils.putString(instance,Index.CITY,location.getCity());

            mLatitude = location.getLatitude();
            mLongitude = location.getLongitude();
            String local_city = location.getCity();//城市名
//            Log.i("myapp","beyond");
//			mLocationClient.stop();
            if (local_city != null) {
                String cityname = local_city.substring(0, local_city.length() - 1).toString();
                SharedPreferencesUtils.setParam(instance, "cityname", cityname);//old
                SPUtils.putString(instance,Index.CITY_NAME,cityname);
            }
            else {
                SharedPreferencesUtils.setParam(instance, "cityname",getString(R.string.localcity_default));//old
                SPUtils.putString(instance,Index.CITY_NAME,"沈阳");
            }
        }
        public void onReceivePoi(BDLocation location) {}
    }
/*百度MAP_end  百度MAP_end  百度MAP_end  百度MAP_end  百度MAP_end  百度MAP_end  百度MAP_end*/
            ...
            public void onDataCallBack(com.alibaba.fastjson.JSONObject data) {
                if (data == null) {
                    ...
                    if (data.getString("msgFlag").equals("1")) {
                        ...
                        Log.e("oldMyApplication", "照片墙信息更新成功");

                        Log.e("oldMyApplication", "个人信息更新成功");
